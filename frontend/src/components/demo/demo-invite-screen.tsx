...
export function DemoInviteScreen({ restaurantSlug }: { restaurantSlug: string }) {
  const router = useRouter();
  const [restaurant, setRestaurant] = useState<DemoRestaurantLanding>(
    buildFallbackDemoLanding(restaurantSlug),
  );
