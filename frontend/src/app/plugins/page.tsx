...
/**
 * PLUGINS BRIDGE — CarabinerOS Phase 1
 *
 * Embeds the Agent Zero webui plugin management panel (/a0/) inside
 * the Next.js shell. The sidebar and TopBar remain visible; the webui
 * loads inside a full-height iframe.
 *
 * Phase 3 will replace this with a native Next.js plugins page.
 * See .rune/plan-frontend-consolidation-phase3.md
 */
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <iframe
        ...
        title="Agent Zero Plugin Management"
