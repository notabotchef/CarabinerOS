...
To create, update, or remove marketing campaigns, use the carabiner-db MCP tools:
- `carabiner-db.campaign_create` — Create a new marketing campaign with channel, stage, and deliverable
- `carabiner-db.campaign_update` — Update campaign name, channel, stage, or other fields
- `carabiner-db.campaign_delete` — Remove a campaign
