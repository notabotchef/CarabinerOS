...
To create, update, or remove prep tasks, use the carabiner_db MCP tools:
- `carabiner_db.prep_create` — Add a new prep task to a station or service lane
- `carabiner_db.prep_update` — Update readiness, shortage, station, or other task fields
- `carabiner_db.prep_delete` — Remove a prep task
