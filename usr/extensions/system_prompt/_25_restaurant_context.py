...
class RestaurantContext(Extension):
    async def execute(
        ...
        **kwargs: Any,
        ...
        context_parts.append("- order_tool — query purchase orders, create new orders, check order status")
        ...
        context_parts.append("- recipe_tool — query recipes, ingredients, costing")
        context_parts.append("- invoice_tool — query invoices, process uploads, match to POs")
